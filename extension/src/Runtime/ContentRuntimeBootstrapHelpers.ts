;(() => {
  ...
  type ContentRuntimeBootstrapHelpersOptions = {
    windowRef?: unknown
    consoleRef?: unknown
    browserRef?: unknown
    chromeRef?: unknown
  ...
  function createDomLockRuntimeForContext(
    ...
    const domLockModule = toRecord(moduleRegistry.runtimeContentRuntimeBootstrapDomLock)
    if (typeof domLockModule.createContentRuntimeBootstrapDomLockRuntime !== 'function') {
    ...
    return (domLockModule.createContentRuntimeBootstrapDomLockRuntime as AnyFn)({
      context,
  ...
  function createSessionRuntimeForContext(
    ...
    const sessionModule = toRecord(moduleRegistry.runtimeContentRuntimeBootstrapSession)
    if (typeof sessionModule.createContentRuntimeBootstrapSessionRuntime !== 'function') {
      // eslint-disable-next-line no-console
    ...
    return (sessionModule.createContentRuntimeBootstrapSessionRuntime as AnyFn)({
      context,
  ...
  function createContentRuntimeBootstrapHelpers(options: ContentRuntimeBootstrapHelpersOptions = {}): LooseRecord {
    const context = createRuntimeBootstrapHelpersContext(options)
    return createBoundContentRuntimeBootstrapHelpers(context)
  }

  let runtimeRegistry = moduleRegistry.runtimeContentRuntimeBootstrapHelpers
  if (!runtimeRegistry || typeof runtimeRegistry !== 'object') {
    runtimeRegistry = {}
    moduleRegistry.runtimeContentRuntimeBootstrapHelpers = runtimeRegistry
  }

  ;(runtimeRegistry as LooseRecord).createContentRuntimeBootstrapHelpers = createContentRuntimeBootstrapHelpers
})()

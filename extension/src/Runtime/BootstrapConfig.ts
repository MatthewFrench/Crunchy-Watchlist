import type { AudioLocaleFilter } from './AudioLocaleFilter.js';
...
type BootstrapConfig = {
  ...
  defaultSettings: {
    ...
    audioLocaleFilter: AudioLocaleFilter;
    genreFilter: string;
    cardLayout: string;
    sortMode: string;
...
export function createRuntimeBootstrapConfigRuntime(): { createBootstrapConfig: () => BootstrapConfig } {
  return {
